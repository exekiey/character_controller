...
public class GroundedWalkingState : PlayerState
{
    ...
    private void StopWalking(InputAction.CallbackContext obj)
    {
        ...
        PlayerPhysics.AccelerationX = PlayerStats.instance.WalkDeceleration * ControlSingleton.MoveDirection;
        WalkStateMachine.SwitchState(WalkStateMachine.DeceleratingState);
